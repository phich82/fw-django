...
MIDDLEWARE = [
    ...
    "app.middlewares.StoreRequestMiddleware.StoreRequestMiddleware",
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            str(BASE_DIR / "app/commons/tags/templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
            ...
            "builtins": [
                ...
                "app.commons.tags.templatetags",
                "app.commons.pipes.filters",
            ],
            "libraries": {
